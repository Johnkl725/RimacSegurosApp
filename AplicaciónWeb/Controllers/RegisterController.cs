...
namespace AplicaciónWeb.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public IActionResult Register(string nombres, string apellido1, string apellido2, string dni, string telefono, string password, string confirmPassword, string userType, string vehiclePlaca, string vehicleMarca, string vehicleModelo, string vehicleTipo, int vehicleTarjeta)
        {
            ...
            var usuario = _usuarioLN.CrearUsuario(nombres, apellido1, apellido2, dni, telefono,hashedPassword, userType);

            if (usuario != null)
            {
                return RedirectToAction("CrearVehiculo", "Beneficiario");
            }
            else
            {
